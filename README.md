...
```bash
$ docker run -ti -p 5000:5000 -p 6006:6006 -p 8888:8888 ai4oshub/diamorph-classification
```
...
```bash
git clone https://github.com/ai4os-hub/diamorph-classification
cd diamorph-classification
docker build -t ai4oshub/diamorph-classification .
docker run -ti -p 5000:5000 -p 6006:6006 -p 8888:8888 ai4oshub/diamorph-classification
```
